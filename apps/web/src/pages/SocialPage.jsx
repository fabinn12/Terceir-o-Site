      ...
      <div className="container mx-auto px-4 max-w-5xl text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {links.map((link) => (
            ...
            >
              <div className={`w-24 h-24 rounded-full ${link.color} text-white flex items-center justify-center text-4xl mb-6 shadow-md transition-transform group-hover:scale-110`}>
                {link.icon}
              </div>
